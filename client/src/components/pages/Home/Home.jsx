    ...
    <>
      ...
      <Container maxW={'3xl'}>
        <Stack
          ...
          <Text color={'gray.500'}>
            {/* Fresh and clean full-stack developer. Highly motivated and extremely ethical.
            I am seeking a full-time position where I can contribute to the organization's goal. <br />
            I'm eager to learn, develop, and accomplish great things. */}
          </Text>
          <Stack
            direction={'column'}
            spacing={3}
            ...
            alignSelf={'center'}
            position={'relative'}>
            <Link href='file:///C:/Users/netan/Downloads/Netanel%20Yaso%20Resume%20(13).pdf'>
              <Button
                colorScheme={'green'}
                bg={'green.400'}
                rounded={'full'}
